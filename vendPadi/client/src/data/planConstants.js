...
export const PLAN_DETAILS = {
  free: {
    ...
    features: [
      ...
      { text: "Flash sales", included: false, icon: FiZap },
  ...
  business: {
    ...
    features: [
      ...
      { text: "Delivery zones", included: true, icon: FiTruck },
      { text: "Flash sales", included: false, icon: FiZap },
      { text: "Product bundles", included: false, icon: FiGift },
    ],
  },
  premium: {
    ...
    features: [
      ...
      { text: "Wishlist for customers", included: true, icon: FiHeart },
      { text: "Verified badge", included: true, icon: FiShield },
      { text: "Flash sales (24hr deals)", included: true, icon: FiZap },
      { text: "Delivery zones", included: true, icon: FiTruck },
      { text: "Product bundles", included: true, icon: FiGift },
